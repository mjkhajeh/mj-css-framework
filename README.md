...
| Width | `w-a`, `w-fit`, `w-full`, `w-100`, `w-100dvw`, `w-95dvw`, `w-90dvw`, `w-16`, `w-20`, `w-24`, `w-28`, `w-32`, `w-36`, `w-48`, `w-64` | Width utilities |
| Height | `h-a`, `h-full`, `h-100`, `h-100dvh`, `h-95dvh`, `h-90dvh`, `h-16`, `h-20`, `h-24`, `h-28`, `h-32`, `h-36`, `h-48`, `h-64` | Height utilities |
